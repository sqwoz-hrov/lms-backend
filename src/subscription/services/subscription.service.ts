...
export class SubscriptionService {
	...
	public async handleRegistration<T extends UserSubscriptionTransaction>(
	...
	public async batchDowngradeToFreeTier({
		freeTier,
		existingSubs,
		meta,
	}: DowngradeSubscriptionParams): Promise<{ downgradedCount: number }> {
		if (freeTier.power > 0) {
